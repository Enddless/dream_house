            ...
            <nav className={css.navigation}>
                <ul className={css.menuLeft}>
                    <li className={css.link} onClick={() => setShowSubmenu(!showSubmenu)}>
                        ...
                        <ul className={classNamesEffects} onMouseLeave={() => setShowSubmenu(!showSubmenu)}>
                            <li className={css.linkItem}><Link to="/">Main menu</Link></li>
                            <li className={css.linkItem}><Link to="/statistics">Statistics</Link></li>
                            <li className={css.linkItem}><Link to="/gallery">Galerry</Link></li>
                            <li className={css.linkItem}><Link to="/steps">Steps</Link></li>
                        </ul>
